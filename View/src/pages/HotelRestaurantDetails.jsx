...
const HotelRestaurantDetail = () => {
  ...
  const fetchDetails = async () => {
    try {
      ...
      // Extract the actual type from URL params
      const actualType = window.location.pathname.includes("/hotel/")
        ? "hotel"
        : "restaurant";

      const response = await fetch(`${backendUrl}/api/${actualType}s/${id}`);
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="bg-gray-900 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <button
            onClick={() => navigate("/hotel_restaurants")}
            className="flex items-center gap-2 text-white hover:text-blue-700 transition-colors duration-200"
          >
            <ArrowLeft size={20} />
            Back to {type === "hotel" ? "Hotels" : "Restaurants"}
          </button>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 mb-5">
              <div className="flex flex-wrap gap-4">
                <button
                  ...
                  className="flex items-center gap-2 bg-blue-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200"
                >
                ...
                <button
                  onClick={handleShare}
                  className="flex items-center space-x-2 text-black hover:text-green-500 transition-colors"
                >
