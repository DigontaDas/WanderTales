...
![Main logo](path/to/wanderTales Logo.png)   
## Purpose: 
...
4. Upload, organize, and share travel photos
5. Real-time weather data for destinations
6. Search by destination, user, tags, or content
7. Users can like & comment on stories 
8. Displays the user's stories, reviews, follower count, and bio
9. Admins can manage users, remove content, or moderate reported items
10. Suggest travel blogs and reviews based on the user’s current or selected location
